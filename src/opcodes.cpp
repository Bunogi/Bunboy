...
namespace GB {
	namespace CPU {
		...
		int opcode34() { INCaddr(HL());                   return 12; } //INC (HL)
		int opcode35() { DECaddr(HL());                   return 12; } //DEC (HL)
		...
		int opcode46() { B = readByte(HL());              return 8;  } //LD B, (HL)
		...
		int opcode4E() { C = readByte(HL());              return 8;  } //LD C, (HL)
		...
		int opcode56() { D = readByte(HL());              return 8;  } //LD D, (HL)
		int opcode57() { D = A;                           return 4;  } //LD D, A
		...
		int opcodeA6() { AND(readByte(HL()));             return 8;  } //AND (HL)
		...
		int opcodeAE() { XOR(readByte(HL()));             return 8;  } //XOR (HL)
		...
		int opcodeB6() { OR(readByte(HL()));              return 8;  } //OR (HL)
		...
		int opcodeBE() { CP(readByte(HL()));              return 8;  } //CP (HL)
